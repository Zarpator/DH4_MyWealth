...
/**
 * LÃ¶sungsvorschlag von Martin Kutscher. Da in der web.xml nur ein
 * Anmeldeverfahren definiert werden kann, programmieren wir den HTTP Basic Auth
 * fÃ¼r den Webservice hier einfach manuell aus.
 *
 * In der web.xml mÃ¼ssen hierfÃ¼r folgende Zeilen ergÃ¤nzt werden, um diese Klasse
 * zu konfigurieren:
 *
 * <filter>
